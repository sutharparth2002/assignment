...
//                 flag!=1?<button disabled='true' className="time-slot" key={`time-${index}`} style={{marginTop:"10px",border:"1px solid black",borderRadius:"10px",padding:"3px",width:"50%"}} onClick={() => handleTimeChange(time,index)}>
//                 {time}
//                 </button>:
//                 <button  className="time-slot" key={`time-${index}`} style={{marginTop:"10px",border:"1px solid black",borderRadius:"10px",padding:"3px",width:"50%"}} onClick={() => handleTimeChange(time,index)}>
//                 {time}
//                 </button>
//             ))}
